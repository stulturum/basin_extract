...
class CreateGRASSprocess(DS):
    ...
    def __init__(self, params):
        ...
        cmd = '# This script comes in two versions, a eplicit versin (B) and one compressed version (B).\n'
        cmd += '# Change the script to be executable by the command:\n'
        cmd += 'chmod 755 %(fpn)s\n' %{'fpn': self.OGRshFPN}
    ...
    def WriteGrassCmdStage4(self):
        ...
        self.OGRshFPN = os.path.join(self.params.stage4scriptfp, OGRshFN)
        ...
        for o in self.finalOutletsD:
            ...
            shpfpn = os.path.join(self.params.stage4datafp, shpfn)
        ...
        # Second alternative for joining all the individual basin polys
