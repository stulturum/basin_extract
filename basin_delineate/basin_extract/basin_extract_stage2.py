...
class ProcStage2BasinOutlets(DS):
    '''
    classdocs
    '''
    ...
    def __init__(self, params):
        ...
        self.stage2datafp = os.path.join(self.datafp, 'stage2')
        self.stage2scriptfp = os.path.join(self.stage2datafp, 'script')
        if not os.path.exists(self.stage2scriptfp):
            os.makedirs(self.stage2scriptfp)
